...
namespace test {
	...
	namespace testsuitescreen {
		...
		void createScreenPoint_ok()
		{
			...
			math::Point2d<int>* screenPoint = screen.getPoint(0, 0);
		...
		void createScreenPoint_invalid()
		{
			...
			math::Point2d<int>* screenPoint = screen.getPoint(250, 250);
			assert(screenPoint == NULL && "Point should be an invalid point in the screen");

			delete screenPoint;
		}

		void checkPointWorldCoords_test(renderer::Screen, math::Point2d<int>*, math::Point2d<int>);
		void checkPointWorldCoords_origin()
		{
			renderer::Screen screen = renderer::Screen(200, 200, math::Point2d<int>(100, 100));

			math::Point2d<int>* point = screen.getPoint(0, 0);
		...
		void checkPointCanvasWorldCoords_test(renderer::Canvas, renderer::Screen, math::Point2d<int>*, math::Point2d<int>);
		...
		void checkPointCanvasWorldCoords_notorigin()
		{
			...
			math::Point2d<int>* point = screen.getPoint(100, 50);
			math::Point2d<int> expected = math::Point2d<int>(-100, -50);
			checkPointCanvasWorldCoords_test(canvas, screen, point, expected);

			delete point;
		}

		void checkPointCanvasCoords_test(renderer::Canvas, renderer::Screen, math::Point2d<int>*, math::Point2d<int>);
		...
		void checkPointCanvasCoords_notorigin()
		{
			...
			// x=0, y positive
			math::Point2d<int>* point = screen.getPoint(0, 100);
			math::Point2d<int> expected = math::Point2d<int>(-100, 0);
			checkPointCanvasCoords_test(canvas, screen, point, expected);
		...
		void checkPointCanvasCoords_differentScale()
		{
			...
			renderer::Canvas canvas = renderer::Canvas(200, 200);
			math::Point2d<int>* point = screen.getPoint(200, 200);
			math::Point2d<int> expected = math::Point2d<int>(0, 0);
			checkPointCanvasCoords_test(canvas, screen, point, expected);
			...
			expected = math::Point2d<int>(50, 0);
			checkPointCanvasCoords_test(canvas, screen, point, expected);
			...
			expected = math::Point2d<int>(200, -100);
			checkPointCanvasCoords_test(canvas, screen, point, expected);
			...
			expected = math::Point2d<int>(0, 200);
			checkPointCanvasCoords_test(canvas, screen, point, expected);
		...
		void checkPointWorldCoords_test(renderer::Screen screen, math::Point2d<int>* point, math::Point2d<int> expected)
		{
			assert(point != NULL && "Point is not a valid point in the screen");

			math::Point2d<int> worldPoint = screen.getScreenToWorldTransform() * (*point);
		...
		void checkPointCanvasWorldCoords_test(renderer::Canvas canvas, renderer::Screen screen, math::Point2d<int>* point, math::Point2d<int> expected)
		{
			assert(point != NULL && "Point is not a valid point in the canvas");

			math::Point2d<int> canvasPoint = screen.toCanvasWorldCoords(*point, canvas);
		...
		void checkPointCanvasCoords_test(renderer::Canvas canvas, renderer::Screen screen, math::Point2d<int>* point, math::Point2d<int> expected)
		{
			assert(point != NULL && "Point is not a valid point in the screen");

			math::Point2d<int> canvasPoint = screen.toCanvasCoords(*point, canvas);
